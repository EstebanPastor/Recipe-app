      ...
      <div className={classes.wrapper}>
        <div className={classes.left}>
          ...
          <div className={classes.buttons}>
            <Link style={{color: "#d49726" , backgroundcolor: "#efefef" }} to="https://www.themealdb.com/" className={classes.buttons}>Get Started</Link>
            <Link to="https://www.themealdb.com/" className={classes.buttons}>Explore recipes</Link>
          </div>
        </div>
